...
var SuperGif = function ( opts ) {
	...
	var player = (function () {
		...
		return {
			...
			get_frame_data: function(idx) { return frames[idx].data },
	...
	return {
		...
		get_frame_data: function(idx) { return player.get_frame_data(idx) },
		load: function (dataAsText, callback) {
			if (callback) load_callback = callback;
			loading = true;

                        if (!initialized ) init();
                        stream = new Stream(dataAsText);
